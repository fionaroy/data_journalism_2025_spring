...
**Answer** Yes, these five CSV files all have the same column structure. 
...
**Answer** It has been loaded (i'm not sure what the question here is)
...
**Answer** The county with the highest 18+ Asian population as a percentage of all population 18 and over is Howard County (19.36%). This county is 52.3% democrats. Compared to the previous answer, this shows that there is a correlation between large percents of the 18+ Black population and a high democrat percentage in a community, but also a correlation between a low percentage of Asian voters 18+ and a high percentage of democrats. This, through base analysis (educated assumption) then correlates to a large percentage of Black voters registering (or at least voting) blue, and a strong likely hood that Asian voters will vote red (or maybe independent etc.). 
