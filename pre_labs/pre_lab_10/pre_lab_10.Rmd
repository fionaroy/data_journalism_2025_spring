...
**Answer** The kind of info it contains is about each school in PG county and their geographic location perimeters. 
...
**Answer** The output shows the entire latitude and longitude perimeters of PG county based upon the gathered data in the shape of a visible map (with, I'm assuming, each school's individual perimeter as well inside the whole county map). 
...
**Answer** It looks similar to the previous glimpse that was ran, which was different than usual, but this time it has a new column which is geometry.
