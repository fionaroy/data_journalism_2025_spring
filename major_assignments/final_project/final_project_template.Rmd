...
-- our most newsworthy finding as of right now (which still is not that flushed out due to the overwhelming lack of data provided to us in raw csv's) --

most likely question four has the biggest potential --> it tracks change in expenditure data (roughly at this point in time, but hopefully maybe will be stronger before final submission) from 2016 findings to first quarter 2025 fiscal year. I think this has the biggest potential to provide substantial findings in where the house of rep's is spending, or not spending, their money so far. and so far, we've already proved that there have been small, if not also significant, changes in their spending which could be fascinating to track more thoroughly if possible 
