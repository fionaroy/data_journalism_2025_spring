...
**A1** The total amount of voters that are seen to be new since July 21 is 17,099. In regards to which counties have seen the largest increase in new voters, they are: Montgomery County with 4847, Baltimore City with 2799, Baltimore County with 1683, Prince George's County with 1669, and Anne Arundel with 1320. Compared to the county population figures in these counties -- and Baltimore City -- (according to the website provided) it appears that the top five counties in my data correlate to the same top five counties (population wise) in the website. These high numbers are on account of the larger population density in these counties. 
